...
var mod_pagespeed_osexOaioTK = "document.querySelectorAll(\".col-theme-icons .elementor-icon\").forEach(link=>{link.addEventListener(\"focus\",()=>link.closest('.elementor-widget-container').classList.toggle(\"focus\"));link.addEventListener(\"blur\",()=>link.closest('.elementor-widget-container').classList.toggle(\"focus\"));});";
